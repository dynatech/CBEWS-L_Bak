...
import SUBSURFACE_PLOT_DATA from '@public/demo-data/subsurface.json';
import SUBSURFACE_COLUMNS from '@public/demo-data/subsurface-columns.json';
...
function SubsurfaceGraph(props) {
  ...
  useEffect(() => {
    ...
    setCommsHealthOption(null);
      const processed = [];
      SUBSURFACE_PLOT_DATA.forEach(({ type, data }) => {

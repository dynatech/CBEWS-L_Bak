                            ...
                            <tr key={`tr-${index}`} class="bg-gray-200 dark:bg-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-yellow-500 dark:text-gray-700 dark:hover:text-gray-100">
                                ...
                                <td class="px-4 py-4 border-r-2 border-gray-400 border-b-2">
                                    <div className='flex gap-6 text-center justify-center'>
                                        <button className="bg-transparent" onClick={()=> { console.log(actions) }}>
                                        ...
                                        <button className="bg-transparent" onClick={actions?.handleDelete}>
                                        ...
                                        <button className="bg-transparent" onClick={actions?.handleView}>
